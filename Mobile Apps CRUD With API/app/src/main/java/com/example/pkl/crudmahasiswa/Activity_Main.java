...
public class Activity_Main extends AppCompatActivity {
    ...
    ArrayList<String> array_nama,array_nim,array_prodi,array_nohp;
   ...
   public void scrollRefresh(){
    ...
    void initializeArray(){
        ...
        array_prodi = new ArrayList<String>();
    ...
    public void getData(){
        initializeArray();
        AndroidNetworking.get("http://172.30.160.1:81/getData.php")
                .setTag("Get Data")
                        ...
                        try{
                            ...
                            if(status){
                                ...
                                for(int i = 0 ; i < ja.length() ; i++){
                                    ...
                                    array_prodi.add(jo.getString("prodi"));
                                    array_nohp.add(jo.getString("nohp"));
                                }
                                recycleViewAdapter = new RecycleViewAdapter(Activity_Main.this,array_nim,array_nama,array_prodi,array_nohp);
